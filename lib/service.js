...
class ZfService {
  ...
  async beforeSuite(suite) {
    ...
    process.stdout.write(`beforeSuite case: ${JSON.stringify(testCase)} \n\n`)
  }
  ...
  async beforeTest(test) {
    ...
    this.test = testResp;
    process.stdout.write(`beforeTest start test: "${JSON.stringify(testResp)}" \n\n`)
  }

  async afterTest(test) {
    process.stdout.write(`afterTest : "${JSON.stringify(test)}" \n\n`)
    ...
    this.test = testResp;
    process.stdout.write(`afterTest finish test: "${JSON.stringify(testResp)}" \n\n`)
  }

  async onComplete(exitCode, config) {
    process.stdout.write(`onComplete : "exitCode: ${exitCode}" "config: ${JSON.stringify(config)}" \n\n`)
    ...
    process.stdout.write(`onComplete : finish test run: ${JSON.stringify(finishTestRunResp)} \n\n`)
